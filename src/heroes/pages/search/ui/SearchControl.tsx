...
export const SearchControl = () => {
    ...
    const activeAccordion = searchParms.get('active-accordion') ?? ''
    const selectedStrength = Number(searchParms.get('strength') ?? '0')
            ...
            <div className="flex flex-col lg:flex-row gap-4 mb-8">
                ...
                <div className="relative flex-1">
                    ...
                    <Input
                        ...
                        defaultValue={searchParms.get('name') ?? ''}
                    />
                </div>
                ...
                <AccordionItem value="advance-filters">
                    ...
                    <AccordionContent>
                        <div className="bg-white rounded-lg p-6 mb-8 shadow-sm border">
                            ...
                            <div className="mt-4">
                                <label className="text-sm font-medium">Minimo de fuerza: {selectedStrength}/10</label>
                                <Slider
                                    defaultValue={[selectedStrength]}
                                    onValueChange={value => setQueryParams('strength', value[0].toString())} max={10} step={1} />
                            </div>
                        </div>
                    </AccordionContent>
                </AccordionItem>
